...
import com.haeva.my.HeavaBoardDelete;
import com.haeva.my.HeavaBoardInsert;
import com.haeva.my.HeavaBoardSearch;
import com.haeva.my.HeavaBoardUpdate;
import com.haeva.my.HeavaGetAllboard;
import com.haeva.my.HeavaImpl;
...
h = new HeavaGetAllboard();

try {
h.haeva(request, response);
} catch (Exception e) {
// TODO Auto-generated catch block
e.printStackTrace();
}
